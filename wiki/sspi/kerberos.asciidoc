...
| `0x26` | `NlChangeMachinePassword`      | _Planned_          | `>=10.0.26080` | `KerbNlChangeMachinePassword`
|===
...
Creates a password bound by CredGuard, then changes the password on the KDC machine account, the password cache, and the logon credentials if applicable.
